...
|r5r|National Public Transport Access Nodes (NaPTAN)|Public transport stops locations|[View Link](https://beta-naptan.dft.gov.uk/)|Connect stops data with timetable data for full GTFS for r5r|
